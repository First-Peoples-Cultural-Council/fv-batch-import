...
public class RelatedPhraseMapper extends DictionaryCachedMapper {
	...
	public RelatedPhraseMapper() {
		...
		String[] definitionCols = {Columns.DOMINANT_LANGUAGE_SENTENCE_DEFINITION, Columns.DOMINANT_LANGUAGE_SENTENCE_DEFINITION + "_2", Columns.DOMINANT_LANGUAGE_SENTENCE_DEFINITION + "_3", Columns.DOMINANT_LANGUAGE_SENTENCE_DEFINITION + "_4", Columns.DOMINANT_LANGUAGE_SENTENCE_DEFINITION + "_5"};
		String[] literalTranslationCols = {Columns.DOMINANT_LANGUAGE_SENTENCE_VALUE, Columns.DOMINANT_LANGUAGE_SENTENCE_VALUE + "_2", Columns.DOMINANT_LANGUAGE_SENTENCE_VALUE + "_3", Columns.DOMINANT_LANGUAGE_SENTENCE_VALUE + "_4", Columns.DOMINANT_LANGUAGE_SENTENCE_VALUE + "_5"};
		String[] culturalNoteCols = {Columns.PHRASE_CULTURAL_NOTE, Columns.PHRASE_CULTURAL_NOTE + "_2", Columns.PHRASE_CULTURAL_NOTE + "_3", Columns.PHRASE_CULTURAL_NOTE + "_4", Columns.PHRASE_CULTURAL_NOTE + "_5"};
		String[] spellingCols = {Columns.PHRASE_ALTERNATE_SPELLING, Columns.PHRASE_ALTERNATE_SPELLING + "_2", Columns.PHRASE_ALTERNATE_SPELLING + "_3", Columns.PHRASE_ALTERNATE_SPELLING + "_4", Columns.PHRASE_ALTERNATE_SPELLING + "_5"};
		...
		propertyReaders.add(new SimpleListPropertyReader(Properties.PHRASE_ALTERNATE_SPELLINGS, spellingCols));
